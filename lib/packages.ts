...
export const packages: SitePackage[] = [
  {
    id: "starter",
    name: "Bas",
    tagline: "Upp till 5 sidor — tydligt och klart",
    who: "Enskilda näringsidkare och nystartade bolag som behöver en seriös hemsida snabbt.",
  ...
  },
  {
    id: "business",
    name: "Premium",
    tagline: "Företagssajt med admin och SEO",
    who: "Småföretag som vill att besökare enkelt ska hitta erbjudandet och hur man tar kontakt.",
  ...
  },
  {
    id: "premium",
    name: "Full Service",
    tagline: "Fler sidor, e-handel och längre support",
    who: "Företag som behöver mer yta, e-handel och support efter lansering.",
  ...
  },
  {
    id: "enterprise",
    name: "Enterprise",
    tagline: "Portaler, integrationer och löpande utveckling",
