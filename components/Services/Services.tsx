    ...
    >
      <div className="mx-auto max-w-6xl px-6 py-20 lg:px-8 lg:py-28">
        ...
        {/* Proof-band: orden ovanför blir trovärdiga först när de går att
            ...
            live-byggda projekt. */}
        <div className="mt-12 overflow-hidden rounded-xl border border-brand-glow bg-brand-tint">
          <div className="flex flex-col gap-6 p-8 sm:flex-row sm:items-center sm:justify-between lg:p-10">
            ...
            <a
              ...
              className="group inline-flex shrink-0 items-center gap-2.5 rounded-pill bg-brand px-7 py-4 font-medium text-white shadow-brand transition-all duration-200 ease-out hover:-translate-y-0.5 hover:bg-brand-dark hover:shadow-lift active:translate-y-0"
            >
              Se min portfolio
              <span
                aria-hidden="true"
