...
const WELCOME: UiMessage = {
  ...
  role: "assistant",
  content:
    "Hej! Jag är Isak. Fråga om tjänster, redesign, hur ett projekt går till eller hur du tar kontakt — jag svarar utifrån det som står på hemsidan.",
};
  ...
  return (
    <>
        ...
        >
          <header className="flex shrink-0 items-start justify-between gap-3 border-b border-line bg-mist px-4 py-3.5 text-ink pt-[max(0.875rem,env(safe-area-inset-top))] sm:pt-3.5">
            ...
            <button
              ...
              className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg text-2xl leading-none text-muted transition-colors hover:bg-mist hover:text-ink"
          ...
          >
            ...
            <div className="flex items-end gap-2">
              <textarea
                ...
                placeholder="Fråga om tjänster, redesign, tid…"
              ...
              <button
                ...
                className="min-h-[2.75rem] shrink-0 rounded-xl border border-transparent bg-ink px-4 py-2.5 text-sm font-medium text-white transition-colors duration-150 hover:bg-ink/85 disabled:opacity-40"
              >
                Skicka
              </button>
            </div>
      ...
      <button
        ...
        className={`pointer-events-auto fixed right-4 bottom-[max(1rem,env(safe-area-inset-bottom))] z-[61] flex h-14 w-14 items-center justify-center rounded-full border border-transparent bg-ink text-white shadow-lift transition-transform duration-150 ease-out hover:scale-105 hover:bg-ink/90 sm:right-6 sm:bottom-6 sm:h-16 sm:w-16 ${
          open ? "max-sm:hidden" : ""
        }`}
      >
